  ...
  data() {
    return {
      jackets: [
        ...
        { name: 'Midnight Blue', swatch: 'swatch-midnightBlue.png', preview: 'jacket-midnightBlueF.png' },
      ...
      kilts: [
        { name: 'Ancient Patriot', swatch: 'swatch-ancientPatriot.png', preview: 'kilt-ancientPatriotF.png' },
